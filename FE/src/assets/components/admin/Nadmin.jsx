...
function Nadmin(){
  ...
  <div className="loading-overlay">
    <Spinner animation="border" variant="warning" />
     ...
     <div style={{backgroundColor:'white',animationDelay: '0s'}} className='mt-5 rounded-3 welcome2'><h3 className='fw-bolder mt-5'>INSERT ADMIN'S DATA</h3><Form onSubmit={submit} className='container mt-4'><Row className='justify-content-center' > 
  ...
  <div className='d-block'><Button type='submit'disabled={loading||!!passwordError||!form.username||!form.email||!form.password} className="text-center border-0  mb-4" style={{background:'#FC7E00'}}  size="lg">Submit</Button></div></Row>
        </Form></div>
    </>)
}
