...
function Nuser(){
  ...
  <div className="loading-overlay">
    <Spinner animation="border" variant="warning" />
     ...
     <div style={{backgroundColor:'white'}} className='mt-5 rounded-3 welcome'><h3 className='fw-bolder mt-5'>INSERT USER'S DATA</h3><Form onSubmit={submit} className='container mt-4'><Row className='justify-content-center' > 
