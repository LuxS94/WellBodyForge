 ...
 const submit = (e) => {
  ...
  <div className="loading-overlay">
    ...
    <div style={{backgroundColor:'white'}} className='mt-5 rounded-3 welcome2'><h3 className='fw-bolder mt-5'>Edit profile</h3><Form onSubmit={submit} className='container mt-4'><Row className='justify-content-center' > 
        ...
        <Form.Control onChange={change} className="mt-2 " type="password" placeholder="*Choose your password" name='password'value={user.password} /></div></Col> <Form.Label className='d-block mt-2 justify-content-center m-1 p-1' style={{color:'grey'}}>*The password must be at least 8 characters long and include at least one uppercase letter, one number, and one special character.</Form.Label> </Row>
         {user.role === "USER"?( <>
